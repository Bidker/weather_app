...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('followed_cities', '0002_auto_20210504_0644'),
        ('users', '0001_initial'),
    ]
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, related_name='users', to='followed_cities.City', verbose_name='followed cities'),
        ),
